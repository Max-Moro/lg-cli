...
SCALA_PROFILES = LanguageElementProfiles(
    ...
    profiles=[
        ...
        # Function/method with body (function_definition)
        ElementProfile(
            name="function",
        ...
        # Abstract function/method (function_declaration - no body)
        ElementProfile(
            name="function",
            query="(function_declaration) @element",
            # Only top-level declarations (not methods inside classes)
            additional_check=lambda node, doc: not is_inside_class(node)
        ),
        ...
        ElementProfile(
            name="method",
            query="(function_declaration) @element",
            # Only methods inside classes (not top-level declarations)
            additional_check=lambda node, doc: is_inside_class(node)
        ),
