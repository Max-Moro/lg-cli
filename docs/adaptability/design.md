# Дизайн функционального блока «Адаптивные возможности»
...
## Описание конкретной фичи

<!-- Мы забыли составить секцию для конкретной фичи, но уже завершили ее разработку -->
<!-- Чтобы выйти из ситуации и провести все таки финальное кодревью, поступаем так -->
{% mode dev-stage:review %}
<!-- обычно секцию src-all неэкономично использовать по токенам, но тут мы принудительно отправим только активные изменения, при работе над фичей -->
${src-all}
{% endmode %}
```
