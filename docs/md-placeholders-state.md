...
На практике на самом деле мы чаще вставляем в шаблоны именно стороннюю документацию. Поэтому нам сейчас необходимо расширить систему плейсхолдеров, добавив специальный синтаксический сахар для данных случаев.
