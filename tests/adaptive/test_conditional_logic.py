...
"""
    ...
    result1 = render_for_test(root, "ctx:tag-conditions", make_run_options())
    ...
    result2 = render_for_test(root, "ctx:tag-conditions", options)
...
"""
    ...
    result1 = render_for_test(root, "ctx:negation-test", make_run_options())
    ...
    options = make_run_options(extra_tags={"minimal"})  
    result2 = render_for_test(root, "ctx:negation-test", options)
...
"""
    ...
    result1 = render_for_test(root, "ctx:tagset-test", make_run_options())
...
"""
    ...
    result1 = render_for_test(root, "ctx:complex-nested", options1)
    ...
    result2 = render_for_test(root, "ctx:complex-nested", options2)
    ...
    options3 = make_run_options(extra_tags={"minimal"})
    result3 = render_for_test(root, "ctx:complex-nested", options3)
...
"""
    ...
    result4 = render_for_test(root, "ctx:parentheses-test", options4)
    assert "Not full agent" in result4
    
    options5 = make_run_options(extra_tags={"agent", "tools"})  # полный agent
    result5 = render_for_test(root, "ctx:parentheses-test", options5)
...
"""
    ...
    result1 = render_for_test(root, "ctx:else-elif-test", options1)
    ...
    result2 = render_for_test(root, "ctx:else-elif-test", options2)
    ...
    result3 = render_for_test(root, "ctx:else-elif-test", options3)
...
def test_custom_tagsets_in_conditions(adaptive_project):
    ...
    write_tags_yaml(root, custom_tag_sets)
...
"""
    ...
    result1 = render_for_test(root, "ctx:custom-tagset", make_run_options())
    ...
    result2 = render_for_test(root, "ctx:custom-tagset", options2)
    ...
    result3 = render_for_test(root, "ctx:custom-tagset", options3)
...
def test_condition_evaluation_performance(adaptive_project):
    ...
    result = render_for_test(root, "ctx:performance-test", options)
