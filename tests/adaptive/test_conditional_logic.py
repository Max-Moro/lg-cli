...
"""
    ...
    result1 = run_render("ctx:tag-conditions", make_run_options())
    ...
    result2 = run_render("ctx:tag-conditions", options)
...
"""
    ...
    result1 = run_render("ctx:negation-test", make_run_options())
    ...
    options = make_run_options(extra_tags={"minimal"})  
    result2 = run_render("ctx:negation-test", options)
...
"""
    ...
    result1 = run_render("ctx:tagset-test", make_run_options())
    ...
    result3 = run_render("ctx:tagset-test", options3)
...
"""
    ...
    result1 = run_render("ctx:complex-nested", options1)
    ...
    result2 = run_render("ctx:complex-nested", options2)
    ...
    options3 = make_run_options(extra_tags={"minimal"})
    result3 = run_render("ctx:complex-nested", options3)
...
"""
    ...
    result4 = run_render("ctx:parentheses-test", options4)
    assert "Not full agent" in result4
    
    options5 = make_run_options(extra_tags={"agent", "tools"})  # полный agent
    result5 = run_render("ctx:parentheses-test", options5)
...
"""
    ...
    result1 = run_render("ctx:else-elif-test", options1)
    ...
    result2 = run_render("ctx:else-elif-test", options2)
    ...
    result3 = run_render("ctx:else-elif-test", options3)
...
"""
    ...
    result = run_render("ctx:mode-conditions", make_run_options())
...
"""
    ...
    result1 = run_render("ctx:custom-tagset", make_run_options())
    ...
    result2 = run_render("ctx:custom-tagset", options2)
    ...
    result3 = run_render("ctx:custom-tagset", options3)
...
def test_condition_evaluation_performance(adaptive_project):
    ...
    result = run_render("ctx:performance-test", options)
