...
BUDGET_STEPS = [773, 742, 726, 636, 621, 536, 305, 202, 153]


@pytest.mark.parametrize("budget", BUDGET_STEPS)
def test_rust_budget_progression_golden(budget: int):
    code = load_sample_code("budget_complex", language="rust")
...
def test_rust_budget_is_monotonic_shrink():
