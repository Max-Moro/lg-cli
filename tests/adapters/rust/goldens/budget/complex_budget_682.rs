// Comprehensive Rust sample for Budget System tests.
// Contains:
// - External imports
// - Local imports
// - Long comments and documentation
// - Big literals (vecs/maps/strings)
// - Public vs private API elements

// … 6 imports omitted (7 lines)

// Local imports (treated as local)
use crate::models::User;
use crate::utils::to_title;
...
by the literal optimizer when budgets are small. It repeats a message to…"#; // literal string (−16 tokens)
