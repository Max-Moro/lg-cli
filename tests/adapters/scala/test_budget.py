"""
Golden tests for Budget System — Scala adapter.
...
BUDGET_STEPS = [779, 746, 696, 603, 583, 533, 297, 275, 193]


@pytest.mark.parametrize("budget", BUDGET_STEPS)
def test_scala_budget_progression_golden(budget: int):
    code = load_sample_code("budget_complex", language="scala")
...
def test_scala_budget_is_monotonic_shrink():
