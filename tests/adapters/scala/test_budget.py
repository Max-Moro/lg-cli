...
BUDGET_STEPS = [779, 737, 590, 526, 505, 464, 400, 324, 194]


@pytest.mark.parametrize("budget", BUDGET_STEPS)
def test_scala_budget_progression_golden(budget: int, do_complex):
    code = do_complex
...
def test_scala_budget_is_monotonic_shrink(do_complex):
