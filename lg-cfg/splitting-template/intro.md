...
lg/template_v2/
├── __init__.py
├── types.py             # Перечень общих типов и IR-модель
...
├── common.py            # Вспомогательные функции для загрузки шаблонов и контекстов
│
...
│   └── processor.py     # Обработка узлов (или в самом plugin.py, если мало логики)
│
