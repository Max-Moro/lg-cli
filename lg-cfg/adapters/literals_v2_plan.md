...
- `lg/adapters/optimizations/literals/`:
  ...
  - `descriptor.py`: `LanguageLiteralDescriptor` с флагами синтаксиса (comment style, raw/template/interp strings, factory wrappers, block_init, ast-seq) и включаемыми профилями → убирает хардкод в коде.
