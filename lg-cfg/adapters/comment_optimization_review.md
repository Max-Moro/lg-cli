...
3. **Вынести группировку комментариев** — Создать mixin для обработки последовательных комментариев Go/Rust
4. **Расширить CommentStyle** — Поддержка нескольких пар doc-маркеров
