...
- Актуализация других оптимизаторов (literals, comments, imports)
...
| Риск | Митигация |
|------|-----------|
| Расхождение результатов с legacy | Golden-тесты покрывают ожидаемое поведение |
| Сложная visibility-логика в некоторых языках | Старый код сохранён как reference |
| Долгий период нестабильности | Этапы 1-3 можно выполнить быстро, основное время — этап 4 |
